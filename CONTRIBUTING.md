...
> # AI policy
> 
> **Contributions must not include content generated by large language models or other generative AI tools.** This covers code, documentation, pull requests, issues, comments, and any other contributions to this project. All of submitted work must be your own.
>
> This approach is mostly based on trust. We trust that you do not lie to us about your usage. We will ask about the usage of AI tools if we see the need, and we will deny pull requests, issues, and other contributions that have LLM or other generative AI use in them. Respect this choice.
